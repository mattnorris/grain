...
################################################################################
# Title:        up-gwt.sh
# Description:  Setup Google Web Toolkit for AJAX development
# Author:       Matthew Norris
# Reference:    http://google-web-toolkit.googlecode.com/files/gwt-linux-1.7.1.tar.bz2
#               http://code.google.com/webtoolkit/download.html
#               http://lists.netfilter.org/pipermail/netfilter/2005-October/063413.html
#
################################################################################
...
dlPrefix="http://google-web-toolkit.googlecode.com/files"
dlFileName="gwt-linux-1.7.1"
dlFileExt="tar.bz2"
